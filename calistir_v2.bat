...
echo ================================================
echo   DCB Delamination Tracker  v2
echo   (Sadece catlak ucu dikey cizgisi)
echo ================================================
echo.
...
echo.
echo Baslatiliyor...
python tracker\main_v2.py "%VIDEO_PATH%" --roi 100,80,470,260 --pixels-per-mm 4.4 --no-display
